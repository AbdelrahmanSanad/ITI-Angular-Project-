...
export class FormsComponent {
  ...
  constructor() {
    ...
    if (this.dataFromParent) {
      this.myValidation.value.name = this.dataFromParent.name;
      this.myValidation.value.email = this.dataFromParent.email;
      this.myValidation.value.phone = this.dataFromParent.phone;
      this.myValidation.value.city = this.dataFromParent.city;
      this.myValidation.value.street = this.dataFromParent.street;
      this.myValidation.value.suite = this.dataFromParent.suite;
    }
  }
